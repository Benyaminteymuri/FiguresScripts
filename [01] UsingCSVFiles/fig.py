...
a1, a2, a3 = np.loadtxt('xarray.csv', delimiter=' ', unpack=True)
b1, b2, b3 = np.loadtxt('yarray.csv', delimiter=' ', unpack=True)

#PDR
function1 = ax1.plot(a2, a1, '-g', label='xarray') 
function2 = ax1.plot(b2, b1, '--g', label='yarray') 

#ENG
function3 = ax2.plot(a2, a3, '-r', label='xarray') 
function4 = ax2.plot(b2, b3, '--r', label='yarray') 
